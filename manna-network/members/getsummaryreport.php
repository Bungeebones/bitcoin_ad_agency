...
echo 'In getsummaryreport.php line 12 <br>';
...
$unboughtBCHHighest = $getHighestBCHPriceSlotPaid + ($getHighestBCHPriceSlotPaid*1.61803398875);
...
$demo_coin_allotment=round($demo_coin_allotments[1],8);
$min_demo_bid = round($demo_coin_allotments[0],8);

$menu_str .= MORE_INFO_PAGE.'<a style="color:blue; text-decoration:underline;" target="_blank" href="more_info.php?demo_coin_allotments='.$demo_coin_allotment.'&catid='.$q.'&link_cnt_free='.$link_cnt_free.'& page_count='.$page_count.'&free_link_position='.$free_link_position.'&link_cnt_demo='.$link_cnt_demo.'&link_cnt_btc='.$link_cnt_btc.'&price2bnumone='.$unboughtBCHHighest.'&min_demo_bid='.$min_demo_bid.'">Click Here</a></div>';
echo $menu_str;
