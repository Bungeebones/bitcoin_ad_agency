...
// echo '<br>', 			      $password;
 //echo '<br>', 			      $dbname;
//define("DBLOGIN_HOST", "localhost");
//define("DBLOGIN_NAME", "mannanetwork");
//define("DBLOGIN_USER", "root");
//define("DBLOGIN_PASS", "M1y1s1q1l1***###");


//define("DBLOGIN_HOST", $servername);
//define("DBLOGIN_NAME", $dbname);
//define("DBLOGIN_USER", $username);
//define("DBLOGIN_PASS", $password);
//HAD TO RENAME ALL THE ABOVE BECAUSE WORDPRESS USES THEM ADDED "LOGIN" AFTER "DB"
//HAD TO CHANGE THEM IN THE CLASS/REGISTRATION.PHP FILE LINE 67
//HAD TO CHANGE THEM IN THE CLASS/LOGIN.PHP FILE LINE 143
/**
...
define("COOKIE_DOMAIN", ".agent3.com");
...
define("EMAIL_SMTP_HOST", 'ssl://mail.bitcoin101.today'); 
define("EMAIL_SMTP_AUTH", true); // leave this true until your SMTP can be used without login
define("EMAIL_SMTP_USERNAME", 'robert@bitcoin101.today');
...
define("EMAIL_PASSWORDRESET_URL", "https://Manna-Network.com/members-password-reset");
define("EMAIL_PASSWORDRESET_FROM", "robert@Manna-Network.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Manna Network reset");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Manna Network registration");
...
define("EMAIL_VERIFICATION_URL", "https://bitcoin101.today/members-register");
define("EMAIL_VERIFICATION_FROM", "robert@bitcoin101.today");
define("EMAIL_VERIFICATION_FROM_NAME", "Manna Network registration");
define("EMAIL_VERIFICATION_SUBJECT", "Manna Network Account Activation & Registration");
