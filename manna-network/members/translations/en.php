...
<li>Receive 50% commissions* on whatever your registered advertisers ever spend for their advertising in the network (you receive commissions in either and/or both the demo coins as well as the Bitcoin Cash they spend).</li>
...
* Commissions earned as \"Demo Coin\" are spendable and transferable to other members but are not backed nor redeemable for anything other than for better placement in the Manna Network. Commissions earned from ads purchased with Bitcoin Cash, on the other hand, are redeemable for Bitcoin Cash.");
...
/*
define("EXPANDED_AJAX_NUM_LINKS", "The total number of free, non-paying links, <b>PLUS</b> paying \"Demo coin\" links <b>PLUS</b> paying Bitcoin Cash links listed ahead of your's in this category is: ");
...
define("EXPANDED_AJAX_MIN_BCH_BID2", " Bitcoin Cash paying advertisers in this category. To be listed ahead of theirs, make a deposit of Bitcoin Cash and purchase a price slot at whatever level among the Bitcoin Cash links you wish. The lowest price is ");
...
define("WIDGET_BITCOINCASH_ADDRESS", "<h3><b>After installion</b>, you will need a Bitcoin Cash address address to receive earnings (An example of a Bitcoin/Bitcoin cash address - 1BvBMSEYstWetqTFn5Au4m4GFg7xJaNVN2) where your commission earnings can be sent (upon request). Need to learn about this? Need a Bitcoin Cash wallet? Take the begginner course below. </h3>");
