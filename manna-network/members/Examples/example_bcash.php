 ...
 */ 
	...
	$options = array( 
//	"public_key"  => "2433AA4VYDdBitcoin77BTCPUBRsBpE902pgp0ZRrymwLFfX0H", 		// place your public key from gourl.io
//	"private_key" => "2433AA4VYDdBitcoin77BTCPRV314V0dQgLhGUBIoQz4YitBTl", 		// place your private key from gourl.io

"public_key"  => "21427AAAfSSpBitcoincash77BCHPUBlr9kR994UFujAsHgFpL",
"private_key" => "21427AAAfSSpBitcoincash77BCHPRVi8vfw9w9F5Mdy5PdrJU",
	"webdev_key" => "DEV203G63E62DAFCFD1764G17084054", 		// optional, gourl affiliate key
	"orderID"     => "Pre_Paid_Advertising_Fund", // few your users can have the same orderID but combination 'orderID'+'userID' should be unique. 
								// for example, on premium page you can use for all visitors: orderID="premium" and userID="" (empty).
	"userID" 	  => $_GET['user_id'], 		// optional; when userID value is empty - system will autogenerate unique identifier for every user and save it in cookies
	...
	"amountUSD"   => 5,  		// price is 2 USD; it will convert to cryptocoins amount, using Live Exchange Rates
...
include($_SERVER['DOCUMENT_ROOT'].'/960btctop.php');
