...
/*
  file holds values like this                           
                            define("READER_CUSTOMERS", "cusread_auth.php");
                             define("WRITER_CUSTOMERS", "cuswrit_auth.php");
				 define("READER_AGENTS", "ageread_auth.php");
 				define("WRITER_AGENTS", "agewrit_auth.php");
define("DB_NAME_CUSTOMERS", "stbitcoi_ma_customers");
define("DB_NAME_AGENTS", "stbitcoi_ma_agents");
...
/*
files hold values like this
     $servername = "localhost";
			      $username = "stbitcoi_cuswrit";
			      $password = "3ZFIMU9dOAxcMStOhubFNDvfNAbC3Sgs";
			      $dbname = "stbitcoi_ma_customers";
*/
...
$pieces = explode("/", $_SERVER['PHP_SELF']);
			echo '<h3 style="color:red; text-align:left;">Your registration and web site information was successfully placed in the Manna Network queue for administrative review and approval (before going live across the whole network). Please allow 24-48 hours for this process and for your website listing to appear in the Manna Network member\'s websites.</h3>
				<h3 style="color:red; text-align:left;">The link approval process does NOT hinder your ability to correctly install any of our Bitcoin-earning scripts BUT it may affect the potential earnings of any sites that register there before your approval! If you are eager for everyone to get started earning Bitcoin with their website, use the contact form at your agent site or at Manna-Network.com and request a quick review from the administrators. They are glad to receive the feedback and can likely get the approval through faster.</h3>

<h3 style="color:red; text-align:left;">
In order to install either the PHP or the Wordpress scripts you will need the following information with which to configure them properly. Write down and store the following info:
<ul><li>Agent ID - '.AGENT_ID.'</li>
<li>Agent URL - '.$_SERVER['SERVER_NAME'].'</li>
<li>Agent Folder Name - '.$pieces[1].' </li>
<li>Your Link ID (or affiliate number) - '.$link_id.'</li>
</ul></h3>

<h3 style="color:red; text-align:left;">Please verify the accuracy of both the Agent URL and Agent Folder Name by comparing them to the actual url in the browser you are on!
