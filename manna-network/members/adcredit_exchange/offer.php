...
<tr><td>
<p class='smallerFont' >Enter The Number Of Credits You Wish To Sell</p></td><td><input type='text' name='num_credits_4sale' value='".$num_credits_4sale."' size='5'>

<span class='error'> ". $num_credits_4saleErr."</span></td></tr>
<tr><td><p class='smallerFont' >The CURRENT Price You Would Receive* ";
...
$msg .=   "(The Default Price Entered Is The Current Bitstamp Bitcoin Price. The price offered to the perspective buyers will be the then current Bitstamp price. )";
}
else
{
...
$msg .=   ">Check Here To Acknowledge You Agree To Post At The Then Current Market Price AT The Time The Buyer Agrees To Purchase ** </td><td><input type='checkbox' name='market_ordertoserver'";
...
<tr><td>
<p class='smallerFont' >Enter The Three Character \"NAME\" Of The Currency You Want To Get Paid In (examples USD, EUR, JPY etc) </td><td><input type='text' name='currency' size='3' value='".$currency."'>
<span class='error'> ". $currencyErr."</span>
</td></tr>
<tr><td>
<p class='smallerFont' >Enter The Name Of Your Bank**</td><td><input type='text' name='bank_name' value='".$bank_name."' size='5'>
<span class='error'> ". $bank_nameErr."</span>
</td></tr>


<tr><td>
<p class='smallerFont' ><br>Enter Your Bank Account Number***</td><td><input type='text' name='bank_acct_num' size = '30' value='".$bank_acct_num."' >
<span class='error'> ". $bank_acct_numErr."</span>
</td></tr>
<tr><td colspan='2'><p class='smallerFont' >*Bungeebones does NOT set the market price and it will be constantly changing. When a buyer looks at your \"AdCredits for sale\" listing it will display the then current market price. That displayed price, too, can fluctuate (the buyers are made aware of that) until such time as the buyer actually commits to buying them. At that time both the price is locked in AND the AdCredits are frozen until at least the expiration of the first time period (if the buyer hasn't responded they made the deposit then the AdCredits are un-frozen automatically). 

</td></tr>
<tr><td colspan='2'><p class='smallerFont' > ** This will be displayed to all perspective buyers so that they can determine if there is a branch of your bank near them.
...
<tr><td colspan='2'><p class='smallerFont' >***This is required in order for the buyer to be able to deposit cash to your account. The account number is on the bottom of your checks but it will NOT be displayed publicly until and except to a buyer who has accepted your offer.
<hr>
