...
echo'</h2>
<h4> To configure your web directory, open the "manna-configs/db_cfg/agent_config.php" file of your installation and change the line $lnk_num = \'change_me\'; to read $lnk_num = \''.$new_user_affiliate_num.'\';';
}
else
{
