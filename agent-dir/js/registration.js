...
document.getElementById("regional_name").value = myarr[2];
  xmlhttp.open("GET","getsubloc1.php?regional_num="+myarr[1]+"&subloc=1",true);
  xmlhttp.send();
}
...
document.getElementById("regional_num").value = myarr[1];
document.getElementById("regional_name").value = myarr[2];
  xmlhttp.open("GET","getsubloc1.php?regional_num="+myarr[1]+"&subloc=2",true);
  xmlhttp.send();
}
...
document.getElementById("regional_name").value = myarr[2];
  ...
  xmlhttp.open("GET","getsubloc3.php?regional_num="+myarr[1]+"&subloc=3",true);
  xmlhttp.send();
}
...
document.getElementById("category_name").value = myarr[2];
  ...
  xmlhttp.open("GET","getsubcat1.php?q="+myarr[1]+"&subcat=1",true);
  xmlhttp.send();
}
...
document.getElementById("category_name").value = myarr[2];
document.getElementById("category_id").value = myarr[1];
  xmlhttp.open("GET","getsubcat1.php?q="+myarr[1]+"&subcat=2",true);
  xmlhttp.send();
  }else{
...
document.getElementById("category_id").value = myarr[1];
  ...
  xmlhttp.open("GET","getsubcat1.php?q="+myarr[1]+"&subcat=3",true);
  xmlhttp.send();
  }else{
...
document.getElementById("category_name").value = myarr[2];
document.getElementById("category_id").value = myarr[1];
  xmlhttp.open("GET","getsubcat1.php?q="+myarr[1]+"&subcat=4",true);
  xmlhttp.send();
  }else{
document.getElementById("category_name").value = myarr[2];
document.getElementById("category_id").value = myarr[1];
