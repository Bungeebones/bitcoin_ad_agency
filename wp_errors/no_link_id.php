...
$url = $_POST['http_host'];
	...
	{
	echo '<h3 style="color:red;">We have not detected that your website is registered at the website you configured as the agent url in the wp-content/plugins/mannanetwork/agent_config.php  page. </h3><h3>You configured your agent url to be '.AGENT_URL;



	echo '<h3 style="color:red;">If you haven\'t registered yet then please either <a target="_blank" href="'.AGENT_REGISTRATION_PAGE.'">visit that agent\'s registration page</a> or select one of the other agents in the list at <a target=_blank" href="http://manna-network.cash/agents_list.php">agent\'s list</a></h3>';
